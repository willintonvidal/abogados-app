...
<div class="Newsletter">
  <h4>NEWSLETTER</h4>
  <p>Recibe las últimas noevdades sobre frontend y tecnologia en tu correo</p>
  <form
    action="https://tinyletter.com/wilintonvidal"
    method="post"
    target="popupwindow"
    onsubmit="window.open('https://tinyletter.com/wilintonvidal', 'popupwindow', 'scrollbars=yes,width=800,height=600');return true">
